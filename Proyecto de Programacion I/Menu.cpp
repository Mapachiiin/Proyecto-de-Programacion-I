...
void Menu::menuAgregarSucursal() {
	...
	cout << "Ingrese el cantón de la sucursal: ";
	getline(cin, cant);

	cout << "Ingrese el correo electrónico de la sucursal: ";
	getline(cin, corr);

	do {
		cout << "Ingrese la capacidad máxima de clientes de la sucursal: ";
		cin >> capCli;
		cin.ignore();
		if (capCli <= 0) {
...
void Menu::menuEliminarSucursal() {
	...
	do {
		string codigo;
		cout << "\n\n---Bienvenido, ingrese el código de la sucursal que desea eliminar---\n\n" << endl;
